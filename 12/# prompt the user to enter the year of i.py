...
country_of_interest = input('Enter the country of interest: ').lower() # convert to lowercase
...
with open ('life-expectancy.csv') as file:
    ...
    for line in file:
        ...
        # find the highest and lowest life expectancy for the given country (case-insensitive)
    ...
    if country_max_year is not None:
        ...
        print(f"Average life expectancy: {sum(life_expectancy_list) / len(life_expectancy_list):.2f}")
    else:
